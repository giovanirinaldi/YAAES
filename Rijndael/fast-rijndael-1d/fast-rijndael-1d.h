#ifndef __FAST_RIJNDAEL_1D_H__
#define __FAST_RIJNDAEL_1D_H__
...
static const int _inv_sbox[256] = 
...
class FastRijndael {
	public:
		...
		void subBytesFirstColumn(unsigned char* block);
		...
		void mixFirstColumn(unsigned char* block);
